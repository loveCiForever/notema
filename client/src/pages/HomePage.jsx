...
function HomePage() {
  ...
  return (
    <div className="bg-white w-full min-h-screen transition-color">
      {/* Header */}
      <header className="flex justify-end items-center">
        <div className="flex items-center gap-2">
          <span className="text-gray-500 px-2 cursor-default">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5  gap-4">
            <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
              ...
              <p className="text-gray-700">New page</p>
            </div>
            <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
              <div className="h-10 mb-4 flex items-center">
                <FileText className="w-6 h-6 text-gray-400" />
            ...
            <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer bg-green-50">
              <div className="h-10 mb-4 flex items-center">
                <CheckCircle className="w-6 h-6 text-green-600" />
              </div>
              <p className="text-gray-700">Tasks Tracker</p>
            </div>
            <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
              <div className="h-10 mb-4 flex items-center">
                <FileText className="w-6 h-6 text-gray-400" />
              </div>
              <p className="text-gray-700">addd</p>
            </div>
            <div className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
              <div className="h-10 mb-4 flex items-center">
